...
public class UI {
	...
	private static void printCapturedPieces(List<ChessPiece> captured) {
		...
		List<ChessPiece> white = captured.stream().filter(cp -> cp.getColor() == Color.WHITE).toList();
		List<ChessPiece> black = captured.stream().filter(cp -> cp.getColor() == Color.BLACK).toList();
